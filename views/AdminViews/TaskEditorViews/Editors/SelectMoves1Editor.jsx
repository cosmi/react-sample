...
var SelectMoves1Editor = React.createClass({
  propTypes: {
  ...
  parseResults: function(results) {
    ...
    var corr = _.every(res, this.isMoveValid);
    if(corr) {
      return res;
    }
  },
      ...
      <div>
        ...
        <div className={"form-group" + (result?"":" has-error")}>
          <label>Poprawna odpowiedź.
            ...
            Ruchy należy oznaczać notacją algebraiczną pełną, oznaczając figury zgodnie z legendą (z wyjątkiem piona) oraz pomijając oznaczenie bicia (np. Ka2-b3 lub c3-c4)</label>
...
module.exports = SelectMoves1Editor;
